...
internal class AnimePaheEpisodeInfo
{
    ...
    [JsonPropertyName("episode2")]
    public double Episode2 { get; set; }

    [JsonPropertyName("edition")]
    public string Editon { get; set; } = string.Empty;
...
internal class AnimePaheEpisodeStream
{
    ...
    [JsonPropertyName("kwik")]
    public string Kwik { get; set; } = string.Empty;

    [JsonPropertyName("kwik_pahewin")]
    public string KwikPahewin { get; set; } = string.Empty;
}
