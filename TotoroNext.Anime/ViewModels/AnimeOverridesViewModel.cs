...
public partial class AnimeOverridesViewModel(OverridesViewModelNavigationParameters paramters,
                                             IAnimeOverridesRepository animeOverridesRepository,
                                             IEnumerable<Descriptor> descriptors) : ObservableObject, IInitializable
{
    [ObservableProperty]
    public partial bool IsNsfw { get; set; }

    [ObservableProperty]
    public partial Guid? ProviderId { get; set; }
    ...
    public void Initialize()
    {
        ...
        this.WhenAnyValue(x => x.IsNsfw, x => x.ProviderId)
            ...
            .Subscribe(@override => animeOverridesRepository.CreateOrUpdate(paramters.Anime.Id, @override));
    }
}
